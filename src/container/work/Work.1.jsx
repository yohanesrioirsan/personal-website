export function Work() {
  return (
    <section className="w-full h-screen flex justify-center items-center flex-col gap-3">
      ...
      <div className="w-full lg:w-[638px] bg-[#CECECE] p-6 rounded-t-lg rounded-b-md lg:rounded-t-2xl lg:rounded-b-lg drop-shadow-xl">
        <div className="grid crid-cols-2 gap-4"></div>
      </div>
    </section>
  );
}
